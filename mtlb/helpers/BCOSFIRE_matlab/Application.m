function [ resp segresp r1 r2] = Application( image,th)
...
if nargin<1
    image = imread('./data/DRIVE/test/images/01_test.tif');
end
...
[resp segresp r1 r2] = BCOSFIRE(image, symmfilter, asymmfilter, 0.5, th);