...
path(path,'helpers/BCOSFIRE_matlab/Gabor/');
path(path,'helpers/BCOSFIRE_matlab/COSFIRE/');
path(path,'helpers/BCOSFIRE_matlab/Preprocessing/');
path(path,'helpers/BCOSFIRE_matlab/Performance/');
